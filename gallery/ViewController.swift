...
class SettingsViewController: UIViewController {
    ...
    private func makeConstraints() {
        numberOfColumnsSlider.snp.makeConstraints {
            $0.top.equalTo(view.safeAreaLayoutGuide.snp.top).offset(100)
            $0.centerX.equalToSuperview()
            $0.width.equalTo(300)
            $0.height.equalTo(20)
        }
        interItemSpacingSlider.snp.makeConstraints {
            $0.top.equalTo(numberOfColumnsSlider.snp.bottom).offset(20)
            $0.centerX.equalTo(numberOfColumnsSlider)
            $0.width.equalTo(numberOfColumnsSlider)
            $0.height.equalTo(numberOfColumnsSlider)
        }
